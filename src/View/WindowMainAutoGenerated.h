...
public:
    ...
    void setupUi(QMainWindow *WindowMain)
    {
        ...
        verticalLayout_3->addWidget(screen);
        ...
        sizePolicy1.setHeightForWidth(labelInspectorGameObjectName->sizePolicy().hasHeightForWidth());
        labelInspectorGameObjectName->setSizePolicy(sizePolicy1);
        QFont font;
        font.setPointSize(15);
        font.setBold(true);
        font.setWeight(75);
        labelInspectorGameObjectName->setFont(font);
        ...
        widgetTreeExplorerDirTree->setMaximumSize(QSize(150, 16777215));
    ...
    void retranslateUi(QMainWindow *WindowMain)
    {
        ...
        actionOpenScene->setShortcut(QApplication::translate("WindowMain", "Ctrl+O", 0, QApplication::UnicodeUTF8));
        actionSaveSceneAs->setText(QApplication::translate("WindowMain", "Save Scene as...", 0, QApplication::UnicodeUTF8));
        actionSaveSceneAs->setShortcut(QApplication::translate("WindowMain", "Ctrl+Shift+S", 0, QApplication::UnicodeUTF8));
        ...
        actionNewScene->setShortcut(QApplication::translate("WindowMain", "Ctrl+N", 0, QApplication::UnicodeUTF8));
        actionSaveScene->setText(QApplication::translate("WindowMain", "Save Scene", 0, QApplication::UnicodeUTF8));
        actionSaveScene->setShortcut(QApplication::translate("WindowMain", "Ctrl+S", 0, QApplication::UnicodeUTF8));
        ...
        actionBuild->setShortcut(QApplication::translate("WindowMain", "Ctrl+B", 0, QApplication::UnicodeUTF8));
        actionBuildAndRun->setText(QApplication::translate("WindowMain", "Build and Run", 0, QApplication::UnicodeUTF8));
        actionBuildAndRun->setShortcut(QApplication::translate("WindowMain", "Ctrl+Shift+B", 0, QApplication::UnicodeUTF8));
