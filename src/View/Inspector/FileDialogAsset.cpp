...
FileDialogAsset::FileDialogAsset(const std::string& topDir,
...
bool FileDialogAsset::eventFilter(QObject *o, QEvent *e)
{
...
void FileDialogAsset::SetTopDir(const std::string &topDirectory)
{
...
QString FileDialogAsset::GetTopDir() const
{
    return topDir;
}

std::string FileDialogAsset::GetOpenFileName()
{
...
bool FileDialogAsset::PathFits(const QString &path) const
{
