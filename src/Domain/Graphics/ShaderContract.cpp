...
const String ShaderContract::Macro_Draw_To_GBuffer_VS_Declare =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_VS_DECLARE()";
const String ShaderContract::Macro_Draw_To_GBuffer_VS_Init_Main =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_VS_INIT_MAIN()";
const String ShaderContract::Macro_Draw_To_GBuffer_VS_End_Main =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_VS_END_MAIN()";
const String ShaderContract::Macro_Draw_To_GBuffer_FS_Declare =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_FS_DECLARE()";
const String ShaderContract::Macro_Draw_To_GBuffer_FS_Init_Main =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_FS_INIT_MAIN()";
const String ShaderContract::Macro_Draw_To_GBuffer_FS_End_Main =
        ShaderContract::ShaderNames_Prefix + "DRAW_TO_GBUFFER_FS_END_MAIN()";
const String ShaderContract::Macro_Post_Render_VS_Declare =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_VS_DECLARE()";
const String ShaderContract::Macro_Post_Render_VS_Init_Main =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_VS_INIT_MAIN()";
const String ShaderContract::Macro_Post_Render_VS_End_Main =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_VS_END_MAIN()";
const String ShaderContract::Macro_Post_Render_FS_Declare =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_FS_DECLARE()";
const String ShaderContract::Macro_Post_Render_FS_Init_Main =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_FS_INIT_MAIN()";
const String ShaderContract::Macro_Post_Render_FS_End_Main =
        ShaderContract::ShaderNames_Prefix + "POST_RENDER_FS_END_MAIN()";

const String ShaderContract::Macro_Draw_To_GBuffer_VS_Declare_Content =
"\
#version 130 \n\
\n\
...
const String ShaderContract::Macro_Draw_To_GBuffer_VS_Init_Main_Content =
"\
/* Fill vin values */ \n\
...
const String ShaderContract::Macro_Draw_To_GBuffer_VS_End_Main_Content =
"\
...
const String ShaderContract::Macro_Draw_To_GBuffer_FS_Declare_Content =
"\n\
#version 130 \n\
\n\
uniform mat4  B_matrix_model; \n\
...
const String ShaderContract::Macro_Draw_To_GBuffer_FS_Init_Main_Content =
"\n\
/* Fill vin vin */ \n\
...
const String ShaderContract::Macro_Post_Render_VS_Declare_Content =
"\
#version 130 \n\
\n\
uniform mat4  B_matrix_model; \n\
...
\n\
";
const String ShaderContract::Macro_Post_Render_VS_End_Main_Content =
"\
\n\
";

const String ShaderContract::Macro_Post_Render_FS_Declare_Content =
"\
#version 130 \n\
\n\
uniform mat4 B_matrix_view; \n\
